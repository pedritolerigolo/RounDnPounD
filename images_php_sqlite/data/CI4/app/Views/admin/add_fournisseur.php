...
<head>
    ...
    <title>RounDnPounD | Ajout Fournisseur</title>
...
<body>
    ...
    <main class="profil-page">
        <div class="connexion-window-admin">
            <h1 style="user-select: none;">Nouveau Fournisseur</h1>
            ...
            <form action="<?= site_url('admin/create-fournisseur') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <button type="submit"
                    style="width:100%; padding:12px; background:#003366; color:white; border:none; border-radius:8px; font-weight:bold; cursor:pointer;">
