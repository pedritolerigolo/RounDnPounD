...
<head>
    ...
    <title>RounDnPounD | Produits</title>
        ...
        <div class="connexion-window-admin">
            <header class="profil-header"
                ...
                <span class="material-icons"
                    style="margin-bottom: 30px; margin-right: 20px; user-select: none; font-size: 40px; color: #003366;">inventory_2</span>
            </header>

            <div class="profil-section">
                <ul class="action-list">
                    <?php if (empty($produits)): ?>
                        <li style="user-select: none; padding: 20px; text-align: center; color: #888;">Aucun produit dans le
                            catalogue.</li>
                    <?php endif; ?>
                    ...
                    <?php foreach ($produits as $produit): ?>
                        <li style="user-select: none; display: flex; align-items: center; padding: 15px;">
                            <div class="text" style="user-select: none; flex-grow: 1;">
                                ...
                                <span
                                    style="user-select: none; color: #28a745; font-weight: bold;"><?= number_format($produit->prix, 2, ',', ' ') ?>
                                    €</span>
                            </div>
                            <div style="user-select: none; display: flex; gap: 15px; align-items: center;">
                                <a href="<?= site_url('admin/edit-produit/' . $produit->id) ?>" title="Modifier">
                                    <span class="material-icons" style="user-select: none; color: #003366;">edit</span>
                                </a>

                                <a href="<?= site_url('admin/delete-produit/' . $produit->id) ?>" title="Supprimer"
            ...
            <div style="user-select: none; margin-top: 30px; text-align: center;">
                <a href="<?= site_url('admin/add-produit') ?>"
